package org.jenkinsci.plugins.bitbucket_source_aged;
...
import org.jenkinsci.plugins.branch_source_aged.AgedStrategyTrait;
 ...
 * @author witokondoria
 */
public class AgedRefsStrategyTrait extends AgedStrategyTrait{
    ...
    protected void decorateContext(SCMSourceContext<?, ?> context) {
        if (this.retentionDays > 0) {
            context.withFilter(new AgedRefsStrategyTrait.ExcludeOldBranchesSCMHeadFilter(this.retentionDays));
        }
    }
